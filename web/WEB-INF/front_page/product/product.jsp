	...
	<div class="r wr">
		...
		<div class="box bg_white">
			<ul class="uls i_150x150 x4_150x150">
				<li>
					<a href="productDetail.jsp" title="富一代" target="_blank" class="pic"><img src="	/res/img/pic/ppp.jpg" alt="花花公子男士长袖衬衫" /></a>
					<dl>
		...
		<h2 class="h2 h2_filter mt"><em title="商品筛选">商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			<ul class="uls filter">
				...
				<li><b>品牌：</b><p>
					...
					<a href="/product/list/display.shtml?brandId=1&brandName=花花公子&typeName=${typeName }&typeId=${typeId}" title="花花公子">花花公子</a>
