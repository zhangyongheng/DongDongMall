    ...
    <div class="r wr">
        ...
        <ul class="uls filter">
            ...
            <li><b>品牌：</b>
                <p>
                    ...
                    <a href="/product/list/display.shtml?brandId=1&brandName=花花公子&typeName=${typeName }&typeId=${typeId}"
                       title="花花公子">花花公子</a>
            ...
            <li><b>类型：</b>
                <p>
                    <a href="javascript:void(0);" title="不限" class="here">不限</a>
                    <a href="/product/list/display.shtml?typeId=2&brandId=${brandId }&brandName=${brandName}&typeName=瑜伽服"
                       title="瑜伽服">瑜伽服</a>
        ...
        <div class="mt ofc">
            <ul class="uls i_150x150 x4_150x150b">
                <li>
                    <a href="productDetail.jsp" title="瑜伽服" target="_blank" class="pic"><img src="/res/img/pic/ppp.jpg"
                                                                                             alt="瑜伽服"/></a>
                    <dl>
                        <!-- dt 10个文字+... -->
                        <dt><a href="productDetail.jsp" title="花花公子男士长袖衬衫款" target="_blank">花花公子男士长袖衬衫款</a></dt>
                        <!-- dt 25个文字+... -->
                        <dd class="h40">花花公子男士长袖衬衫款</dd>
            ...
            <div class="page pb15">
				<span class="r inb_a page_b">
                    ...
                    <a href="#" title="第3页">3</a><a href="#" title="第4页">4</a><a href="#" title="第5页">5</a>
                    <span class="break">...</span><a href="#" title="第16页">16</a>
                    <span id="nextNo" class="inb" title="下一页" style="display:none">下一页<samp>&gt;&gt;</samp></span>
                    <a href="javascript:void(0);" id="next" title="下一页">下一页<samp>&gt;&gt;</samp></a>
                    共<var id="pageTotal" class="orange">0</var>页 到第
